...
namespace BreadApp_API.Controllers
{
    ...
    public class TransactionsControllers : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<TransactionDTO>> GetAllTransactions(int? SenderUserID = null, int? ReceiverUserID = null,
            int? BreadPointID = null,
            int? TransactionType = null, int? Status = null,
            int PageNumber = 1, int PageSize = 10)
        {
            return Ok(Transactions.GetAllTransactions(
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public ActionResult<TransactionDTO> GetOneTransactionBy(int? TransactionID = null, Guid? PublicID = null, int? QRCodeID = null)
        {
