...
//        {
//            public TransactionDataDTO(int SenderUserID,
//                int? ReceiverUserID, int? BreadPointID, int? QrToken,
//                decimal Amount, int TransactionType, string? Notes)
//            {
...
//        {
//            public TransactionInfoDTO(Guid PublicID , int SenderUserID,
...
namespace BreadApp_DL
{
    ...
    public class TransactionsData
    {
        ...
        /// </summary>
        public static int CreateTransaction(TransactionModel.TransactionDataDTO transaction)
        {
            using (SqlConnection conn = new SqlConnection(clsConnectionSetting.ConnectionString))
            using (SqlCommand cmd = new SqlCommand("sp_Transactions_Create", conn))
            {
                ...
                cmd.Parameters.AddWithValue("@ReceiverUserID", transaction.ReceiverUserID ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@BreadPointID", transaction.BreadPointID ?? (object)DBNull.Value);
                cmd.Parameters.AddWithValue("@QRToken", transaction.QRToken ?? (object)DBNull.Value);
